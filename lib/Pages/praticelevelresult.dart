...
class PraticeLevelResult extends StatefulWidget {
  final levelId;
  const PraticeLevelResult({Key? key, required this.levelId}) : super(key: key);
...
class _PraticeLevelResultState extends State<PraticeLevelResult> {
  ...
  getUserId() async {
    ...
    levelData.getPraticeLeaderBoard(userId);
  }
                            ...
                            builder: (context, userdata, child) {
                              return Column(
                                ...
                                children: [
                                  ...
                                  MyText(
                                    title:
                                        "${userdata.praticeLeaderboardModel.user?[0].score} Points Earned.",
                                    fontWeight: FontWeight.w500,
                                    colors: white,
                                    size: 18,
                                  ),
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          todaydata.praticeLeaderboardModel.result?[index]
                                  .fullname ??
                              "",
