...
class PratiseQuestions extends StatefulWidget {
  String? catId, levelId, levelname, levelMasterId;
  PratiseQuestions(
      {Key? key,
      required this.catId,
  ...
  @override
  _PratiseQuestionsState createState() => _PratiseQuestionsState();
}
...
class _PratiseQuestionsState extends State<PratiseQuestions> {
  ...
  void initState() {
    ...
    questiondata.getQuestionByLevelPratice(context, widget.catId,
                  ...
                  child: Consumer<ApiProvider>(
                    builder: (context, questiondata, child) {
                      if (!questiondata.loading) {
                        ...
                        questionList = questiondata.questionPraticeModel.result
                            as List<Result>;
